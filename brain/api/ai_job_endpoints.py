...
class JobStatusView(APIView):
    ...
    def get(self, request, job_id):
        try:
            ...
            if hasattr(request.user, 'organization_id') and run.organization != request.user.organization:
                return Response({
                    'error': 'Job not found'
    ...
    def get(self, request, job_id):
        try:
            ...
            trace_data = {
                ...
                'metadata': run.meta,  # Use 'meta' field
                'events': []
            }
            ...
            for event in events:
                trace_data['events'].append({
                    ...
                    'data': event.payload,  # Use 'payload' field
